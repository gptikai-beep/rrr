...
const services = [
  {
    ...
    description: 'Špecializujem sa na opravy iPhonov a všetkých typov smartfónov. Výmena displejov, batérií, konektorov a ďalších komponentov.',
    isPrimary: true,
    image: phoneRepairImage,
    imagePosition: 'center 35%', // Posunúť vyššie
  },
  {
    icon: Tv,
    title: 'Opravy televízorov',
    description: 'Servis televízorov. Riešime problémy s obrazom, zvukom, napájaním a softvérom.',
    isPrimary: true,
    image: tvRepairImage,
    imagePosition: 'center center', // Centrované
  },
  {
    icon: Cpu,
    title: 'Opravy elektroniky',
    description: 'Servis elektronických zariadení. Tablety, herné konzoly, audio zariadenia...',
    isPrimary: true,
  ...
  },
  {
    ...
    description: 'Servis notebookov všetkých značiek. Čistenie, výmena komponentov, preinštalovanie windowsu',
    isPrimary: false,
    image: notebookRepairImage,
    imagePosition: 'center 60%', // Posunúť nižšie aby bolo vidieť celý notebook
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Poskytujeme komplexný servis elektroniky s dôrazom na kvalitu, rýchlosť a spoľahlivosť
            </p>
          </div>
